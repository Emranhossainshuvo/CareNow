...
const MakeAppointment = () => {
    return (
        <>
            ...
            <section style={{ backgroundImage: "url('https://i.ibb.co/FJwvfTm/2149164339.jpg')" }} className="relative md:flex bg-cover bg-opacity-70  md:items-center mb-20 md:justify-between">
